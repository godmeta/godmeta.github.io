// remember to import (in libphos) export (end of this file) when adding new functions!! 2022-11-28
function f_sse_log() 
{
  var S = window.S;
  var button = document.querySelector('button');
  var evtSource = new EventSource('./sse/sse_log.php');
...
function f_dlb() {
    ...
    // 20230608 Debug colour LOL
    //S[3].style.backgroundColor = 'red';
    S[3].style.backgroundColor = 'yellow';
    S[3].onclick = function () {
        M.F(S[1].value); // 20230526 when click red button with nickname, execute words in dialogue box?
    };
    // gui_dsc.js:document.getElementsByTagName('button')[2].setAttribute('type','button')
    S[3].setAttribute('type','button');
    S[0].style.backgroundColor = 'grey';
    window.onbeforeunload = function () {
        return 'Reload?';
    };
